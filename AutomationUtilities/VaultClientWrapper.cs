...
{
    public class VaultClientWrapper {
        ...
        public static async Task<Secret<StaticCredentials>?> GetDBCredentials(IConfigurationRoot config)
        {
            Secret<StaticCredentials> creds = new();
            ...
            creds = await vault.getStaticCredentials("ExtrabotAutomation", roleID, secretID);
